...
/**The basic ground stage compoennt. A solid rectangle that can be any color
*/
public class Ground extends StageComponent implements Rotatable,Resizeable{//ground component
  ...
  */
  ...
  /**Create a ground from serialized binarry data
